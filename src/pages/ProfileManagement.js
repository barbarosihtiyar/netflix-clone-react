          ...
          <div className="imageInfo">
            ...
            <div className="info">
              ...
              <div className="createUsername">
                <span>Your username is a unique name you'll use when playing games with other Netflix members on Netflix Games.</span>
                <input type="text" name="" id="" />
              ...
              <div className="checkbox">
                ...
                <label>Automatically play the next episode on all devices while watching a series.</label>
              </div>
              <div className="checkbox">
                <input type="checkbox" name="" id="" />
                <label>Automatically play all archives with complaints while browsing content.</label>
              </div>
